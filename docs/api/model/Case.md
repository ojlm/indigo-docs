...
case class Request(
                    ...
                    var contentType: String, // 目前只支持 `application/json`, `application/x-www-form-urlencoded`, `text/plain`
                    var body: Seq[MediaObject], // 消息体内容
                  ) {
}
case class MediaObject(
                        contentType: String, // 目前只支持 `application/json`, `application/x-www-form-urlencoded`, `text/plain`
                        data: String // 字符串内容
                      ) {
}
